...
import { Big, isZero } from './big-number.js'
...
const Home: React.FC = () => {
  ...
  const [tokenBalance, setTokenBalance]  =  useState(Big(0))

  

  const web3 = new Web3(new Web3.providers.HttpProvider("https://bsc-dataseed.binance.org/"));
  const presaleContract = new web3.eth.Contract((ERC20ABI as unknown) as AbiItem, '0x8D49b9552D00175E42a3a6d6F5E8F6f59145eeab');
  ...
  if(account){
    ...
    balance = (new BigNumber(balance).div(0.0000000369837))
        ...
        <Page>        
          <div style={{ display: isDesktopOrLaptop? "grid" : "block", gridTemplateColumns: "repeat(3, 1fr)", gridGap: 20 }}>
            ...
            <PageHeader
              ...
              maintitle="GoldenArts - Token Presale"
              title="ARTN"
          ...
          <div style={{display: isDesktopOrLaptop?'flex':'block', width: isDesktopOrLaptop?1072:'auto', margin: isDesktopOrLaptop?"40px auto auto auto":"40px auto"}}>
            <StyledContainer>
              ...
              <div style={{marginTop:'36px', padding:'12px 0', display:'grid', borderBottom:'1px solid rgba(0, 0, 0, 0.3)', }}>
                ...
                <span className='boldFont'>1 ARTN = 0.0000000369837 BNB</span>
              </div>
              <div style={{marginTop:'36px', padding:'12px 0', display:'grid', borderBottom:'1px solid rgba(0, 0, 0, 0.3)', }}>
                <span>ARTN BALANCE</span>
                <span className='boldFont'>{new BigNumber(tokenBalance)
